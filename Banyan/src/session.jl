mutable struct Session
    ...
    function Session(cluster_name::String, session_id::SessionId, resource_id::ResourceId, nworkers::Integer, sample_rate::Integer, worker_memory_used::Integer=0)::Session
        new(session_id, resource_id, nworkers, sample_rate, Dict(), [], Dict(), cluster_name, worker_memory_used)
    end
end
