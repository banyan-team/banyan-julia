...
aws s3 cp scripts/executor.jl s3://banyanexecutor/
aws s3 cp scripts/launch_job.sh s3://banyanexecutor/
aws s3 cp scripts/queues.jl s3://banyanexecutor/
aws s3 cp scripts/setup_cluster.sh s3://banyanexecutor/
aws s3 cp res/pt_lib.jl s3://banyanexecutor/  # Just a default pt_lib.jl
