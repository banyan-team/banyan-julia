@testset "Simple model inference" begin
    use_job_for_testing(scheduling_config_name = "default scheduling") do
        # Download model
        remotepath = "https://github.com/jw3126/ONNXRunTime.jl/raw/main/test/data/increment2x3.onnx"
        localpath = Downloads.download(remotepath)
        ...
        data = BanyanArrays.ones(Float32, (120, 2, 3))
        model = BanyanArrays.load_inference(remotepath)
